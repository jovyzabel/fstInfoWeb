 ...
 */
final class Version20230127091856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pre_registration (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, folder_id INT DEFAULT NULL, speciality_id INT NOT NULL, academic_year_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A2FEF1B9CB944F1A (student_id), UNIQUE INDEX UNIQ_A2FEF1B9162CB942 (folder_id), INDEX IDX_A2FEF1B93B5A08D7 (speciality_id), INDEX IDX_A2FEF1B9C54F3401 (academic_year_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE teacher (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, picture_name VARCHAR(255) NOT NULL, diploma VARCHAR(255) NOT NULL, place_of_acquisition VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, nationality VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B0F6A6D59B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
