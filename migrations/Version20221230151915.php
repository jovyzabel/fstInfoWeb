 ...
 */
final class Version20221230151915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alumni (id INT AUTO_INCREMENT NOT NULL, promotion_id INT DEFAULT NULL, account_id INT DEFAULT NULL, avatar_name VARCHAR(255) NOT NULL, civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, profil VARCHAR(255) NOT NULL, testimonial LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, INDEX IDX_FD567018139DF194 (promotion_id), UNIQUE INDEX UNIQ_FD5670189B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE folder (id INT AUTO_INCREMENT NOT NULL, attestation_of_validation VARCHAR(255) NOT NULL, degree VARCHAR(255) DEFAULT NULL, bulletin VARCHAR(255) DEFAULT NULL, letter LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formation_cycle (id INT AUTO_INCREMENT NOT NULL, featured_image_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_C60D4FE63569D950 (featured_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, pre_registration_id INT DEFAULT NULL, account_id INT DEFAULT NULL, avatar_name VARCHAR(255) NOT NULL, civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, birth_day DATE NOT NULL, birth_place VARCHAR(100) NOT NULL, telephone VARCHAR(40) NOT NULL, email VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_B723AF33F5B7AF75 (address_id), UNIQUE INDEX UNIQ_B723AF33FB6C0FEA (pre_registration_id), UNIQUE INDEX UNIQ_B723AF339B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE teacher (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, avatar_name VARCHAR(255) NOT NULL, civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, diploma VARCHAR(255) NOT NULL, place_of_acquisition VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_B0F6A6D59B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
