 ...
 */
final class Version20230803134853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE academic_year (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, start_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end_at DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE account (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7D3656A4E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE alumni (id INT AUTO_INCREMENT NOT NULL, promotion_id INT DEFAULT NULL, account_id INT DEFAULT NULL, picture_name VARCHAR(255) NOT NULL, profil VARCHAR(255) NOT NULL, testimonial LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, nationality VARCHAR(255) DEFAULT NULL, INDEX IDX_FD567018139DF194 (promotion_id), UNIQUE INDEX UNIQ_FD5670189B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE app_option (id INT AUTO_INCREMENT NOT NULL, current_academic_year_id INT DEFAULT NULL, course_leader_id INT DEFAULT NULL, is_pre_enroll_period TINYINT(1) NOT NULL, display_ciscoon_carousel TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_BF856D302B06A9F7 (current_academic_year_id), UNIQUE INDEX UNIQ_BF856D30F1B40E78 (course_leader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE formation_cycle (id INT AUTO_INCREMENT NOT NULL, featured_image_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C60D4FE63569D950 (featured_image_id), FULLTEXT INDEX search_index (label, description), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, link VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', FULLTEXT INDEX search_index (title, content), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pre_registration (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, folder_id INT DEFAULT NULL, speciality_id INT NOT NULL, academic_year_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, pre_registration_type VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_A2FEF1B9CB944F1A (student_id), UNIQUE INDEX UNIQ_A2FEF1B9162CB942 (folder_id), INDEX IDX_A2FEF1B93B5A08D7 (speciality_id), INDEX IDX_A2FEF1B9C54F3401 (academic_year_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE speciality (id INT AUTO_INCREMENT NOT NULL, formation_cycle_id INT DEFAULT NULL, featured_image_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, goals LONGTEXT DEFAULT NULL, targeted_skills LONGTEXT DEFAULT NULL, careers LONGTEXT DEFAULT NULL, INDEX IDX_F3D7A08EC27E4693 (formation_cycle_id), INDEX IDX_F3D7A08E3569D950 (featured_image_id), FULLTEXT INDEX search_index (label, description), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, account_id INT DEFAULT NULL, picture_name VARCHAR(255) NOT NULL, birth_day DATE NOT NULL, birth_place VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, nationality VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B723AF33F5B7AF75 (address_id), UNIQUE INDEX UNIQ_B723AF339B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE teacher (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, picture_name VARCHAR(255) NOT NULL, diploma VARCHAR(255) NOT NULL, grade VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', civility VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, nationality VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B0F6A6D59B6B5FBA (account_id), FULLTEXT INDEX search_index (name, first_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
